...
export default function MarqueScreen({ onBack, onValidated}) {
    ...
    const toggleCheckbox2 = (item) => { // { key: 'favorite_color' }
      ...
      const items_2 = [
        { key: 'Très court', label: 'Très court' },
        { key: 'court', label: 'Court' },
        { key: 'Taille basse', label: 'Taille basse' },
        { key: 'Taille haute', label: 'Taille haute' },
        { key: 'Mi-long', label: 'Mi-long' },
        { key: 'Long', label: 'Long' },
        { key: 'Très long', label: 'Très long' },
        { key: '7/8', label: '7/8' },
      ]
    ...
    <View style={styles.container}>
         <View style={styles.blocHaut}>
                ...
                <Text style={styles.title}>Longueur</Text>
                </View>
