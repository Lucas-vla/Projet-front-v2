...
export default function MarqueScreen({ onBack, onValidated}) {
    ...
    const toggleCheckbox2 = (item) => { // { key: 'favorite_color' }
      ...
      const items_2 = [
        { key: 'Bretelles fines', label: 'Bretelles fines' },
        { key: 'Bustier', label: 'Bustier' },
        { key: 'Bretelles larges', label: 'Bretelles larges' },
        { key: 'Sans manche', label: 'Sans manche' },
        { key: 'Manches courtes', label: 'Manches courtes' },
        { key: 'Manches très longues', label: 'Manches très longues' },
        { key: 'Manches mi-longues', label: 'Manches mi-longues' },
    ...
    <View style={styles.container}>
         <View style={styles.blocHaut}>
                ...
                <Text style={styles.title}>Longueur des manches</Text>
                </View>
