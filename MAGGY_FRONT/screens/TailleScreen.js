...
export default function MarqueScreen({ onBack, onValidated}) {
    ...
    const toggleCheckbox2 = (item) => { // { key: 'favorite_color' }
      ...
      const items_2 = [
        { key: 'XXS - 32', label: 'XXS - 32' },
        { key: 'XS - 34', label: 'XS - 34' },
        { key: 'S - 36', label: 'S - 36' },
        { key: 'M - 38', label: 'M - 38' },
        { key: 'L - 40', label: 'L - 40' },
        { key: 'XL - 42', label: 'XL - 42' },
        { key: 'XXL - 44', label: 'XXL - 44' },
        { key: '3XL - 46', label: '3XL - 46' },
        { key: '4XL - 48', label: '4XL - 48' },
        { key: '5XL - 50', label: '5XL - 50' },
        { key: 'XXS - 32', label: 'XXS - 32' },
        { key: 'XS - 34', label: 'XS - 34' },
        { key: 'S - 36', label: 'S - 36' },
        { key: 'M - 38', label: 'M - 38' },
