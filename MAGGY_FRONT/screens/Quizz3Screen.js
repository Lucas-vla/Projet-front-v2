...
export default function Quizz3Screen({ navigation }) {
 return (
   <View>
      <View style={styles.blocfleche}>
                 <TouchableOpacity onPress={() => navigation.navigate("Quizz2")}>
                    <FontAwesome name="arrow-left" size={30} color="#553DED" style={styles.fleche} />
                </TouchableOpacity>
                </View>
     <Text>Quizz 3</Text>
     <TouchableOpacity onPress={() => navigation.navigate('Quizz4')} style={styles.btnsuivant}>
