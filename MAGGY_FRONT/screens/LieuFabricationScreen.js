...
export default function MarqueScreen({ onBack, onValidated}) {
    ...
    const toggleCheckbox2 = (item) => { // { key: 'favorite_color' }
      ...
      const items_2 = [
        { key: 'Made in France', label: 'Made in France' },
        { key: 'Made in USA', label: 'Made in USA' },
        { key: 'Made in China', label: 'Made in China' },
        { key: 'Made in Brasil', label: 'Made in Brasil' },
        { key: 'Made in India', label: 'Made in India' },
        { key: 'Made in Bengladesh', label: 'Made in Bengladesh' },
        { key: 'Made in Italia', label: 'Made in Italia' },
        { key: 'Made in Spain', label: 'Made in Spain' },
        { key: 'Made in Portugal', label: 'Made in Portugal' },
        { key: 'Made in Tunisie', label: 'Made in Tunisie' },
        { key: 'Made in Roumania', label: 'Made in Roumania' },
      ]
    ...
    <View style={styles.container}>
         <View style={styles.blocHaut}>
                ...
                <Text style={styles.title}>Lieu de Fabrication</Text>
                </View>
